...
#               The date is determined by incremerge.bash script which does 
...
function show_usage {
echo "usage: incremerge-fastcopy.bash -d <Data Domain> -u <DD User> -m <Mount Point> -h <host> -o <Oracle_sid> -t <mtree>" 
echo " -d : Data Domain"
...
echo "Incremerge-fastcopy.bash script starts at $DATE_SUFFIX" > $runlog 
